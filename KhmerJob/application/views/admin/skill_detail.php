...
?>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-lg-12">				
				<h1 class="page-header">Form Skill Detail</h1>				
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">Skill Detail Information</h3>
					</div>
					<div class="panel-body">							 
							<div class="col-lg-12">
                                <p><b>Skill type: </b><?php echo $detail->rate_det_type;?></p>
                               	<p><b>Duration: </b><?php echo $detail->duration=="0"?"Unlimited":$detail->duration." months";?></p>                               	
                                ...
                                <p><b>Photo/logo space Display: </b><?php echo $detail->photo_space_display=="1"?"Enable":"Disable";?></p>
