<div class="row">
	<div class="col-md-10">
		...
		<table class="table table-bordered table-hover table-striped dataTable no-footer">
	       	...
	       	<tr>
	       		<td><a href="<?php echo base_url('home/jobdetail');?>">Account Staff (01 Posts)<img src="<?php echo base_url('assets/uploads/urgent.gif');?>"></a></td>
	       		<td>Minebea (Cambodia) Co.,Ltd.</td>
	       		<td>Phnom Penh </td>
	       		<td>Mar-15-2017</td>				
	       	</tr>
	       	<tr>
	       	...
	       	<tr>
	       		<td><a href="">Account Staff (01 Posts)<img src="<?php echo base_url('assets/uploads/new.gif');?>"></a></td>
	       		<td>Company</td>
	       		<td>Phnom Penh </td>
	       		<td>Mar-15-2017</td>				
	       	</tr>				
